...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler(f'llama3_70b_zeroshot_{log_timestamp}.log'),
...
OUTPUT_CSV_PATH = f"/spaces/25G05/ZeroShot/llama3_70b_zeroshot_results_{timestamp}.csv"
OLLAMA_API_URL = "http://localhost:11434/api/generate"
MODEL_NAME = "Llama3_70b_zero:latest" 
