...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler(f'llama3_8b_zeroshot_COD_no_{log_timestamp}.log'),
...
OUTPUT_CSV_PATH = f"/spaces/25G05/Rizwaanah/ZeroShot/llama3_8b_zeroshot_COD_no_results_{timestamp}.csv"
OLLAMA_API_URL = "http://localhost:11434/api/generate"
MODEL_NAME = "llama3_8b_zero_COD_no_ICD10:latest"
