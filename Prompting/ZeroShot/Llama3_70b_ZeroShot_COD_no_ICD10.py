#!/usr/bin/env python3
"""
Llama3 8b Zero-Shot with COD list Verbal Autopsy Analysis Script
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler(f'lama3_70b_zeroshot_COD_no_ICD10_{log_timestamp}.log'),
...
OUTPUT_CSV_PATH = f"/spaces/25G05/Aaliyah/ZeroShot/llama3_70b_zeroshot_COD_no_ICD10_results_{timestamp}.csv"
OLLAMA_API_URL = "http://localhost:11434/api/generate"
MODEL_NAME = "llama3_70b_zero_COD_no_ICD10:latest"
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                if MODEL_NAME in model_names:
                    ...
                    logger.warning(f"ollama create {MODEL_NAME} -f /home/seedatr/VA-Analysis/Models/Llama3_8b_zero_COD_no")
            else:
