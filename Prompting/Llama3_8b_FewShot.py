#!/usr/bin/env python3
"""
Llama3 Few-Shot Verbal Autopsy Analysis Script
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler(f'llama3_fewshot_{log_timestamp}.log'),
...
OUTPUT_CSV_PATH = f"/spaces/25G05/FewShot/llama3_fewshot_results_{timestamp}.csv"
OLLAMA_API_URL = "http://localhost:11434/api/generate"
MODEL_NAME = "llama3_VA2:latest" 
