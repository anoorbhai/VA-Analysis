...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler(f'llama4_zeroshot_COD_{log_timestamp}.log'),
...
OUTPUT_CSV_PATH = f"/spaces/25G05/ZeroShot/llama4_zeroshot_COD_results_{timestamp}.csv"
OLLAMA_API_URL = "http://localhost:11434/api/generate"
MODEL_NAME = "llama4_VA_COD_zero:latest" 
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                if MODEL_NAME in model_names:
                    ...
                    logger.warning(f"ollama create {MODEL_NAME} -f /home/noorbhai/VA-Analysis/Models/Llama3_8b_zero_COD")
            else:
