#!/usr/bin/env python3
"""
Llama3 8b Few-Shot using the COD list Verbal Autopsy Analysis Script
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler(f'llama3_8b_fewshot_{log_timestamp}.log'),
...
OUTPUT_CSV_PATH = f"/spaces/25G05/CODlist/llama3_8b_fewshot_COD_results_{timestamp}.csv"
OLLAMA_API_URL = "http://localhost:11434/api/generate"
MODEL_NAME = "llama3_8b_Few_COD:latest" 
