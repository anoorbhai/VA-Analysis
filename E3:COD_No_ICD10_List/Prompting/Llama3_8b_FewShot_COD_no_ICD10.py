...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler(f'llama3_8b_fewshot_COD_no_{log_timestamp}.log'),
...
OUTPUT_CSV_PATH = f"/spaces/25G05/Rizwaanah/FewShot/llama3_8b_fewshot_COD_no_results_{timestamp}.csv"
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                if MODEL_NAME in model_names:
                    ...
                    logger.warning(f"ollama create {MODEL_NAME} -f /home/seedatr/VA-Analysis/Models/Llama3_8b_few_COD_no")
            else:
