...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler(f'llama3_70b_zeroshot_61_{log_timestamp}.log'),
...
OUTPUT_CSV_PATH = f"/spaces/25G05/Rizwaanah/ZeroShot/llama3_70b_zeroshot_61_results_{timestamp}.csv"
...
def main():
    ...
    logger.info("Starting Llama3:70b Zero-Shot VA Analysis")
